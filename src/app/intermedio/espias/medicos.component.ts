...
export class MedicosComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.medicoService.getMedicosService().subscribe(medicos => this.medicos = medicos);
  ...
  agregarMedico() {
    ...
    this.medicoService.agregarMedicoService(medico).subscribe(
  ...
  borrarMedico(id: string) {
    ...
    if (confirmar) {
      ...
      this.medicoService.borrarMedicoService(id);
